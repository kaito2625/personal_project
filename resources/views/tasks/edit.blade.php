                    ...
                    <div class="col col-md-offset-3 col-md-6">
                        <nav class="panel-default">
                            ...
                            <div class="panel-body">
                                <form action="/folders/{{ $folder->id }}/tasks/{{ $tasks->id }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <label for="title">タイトル</label>
                                        <input type="text" class="form-control" name="title" id="title" value="{{ old('title', $tasks->title) }}"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="due_date">期限</label>
                                        <input type="text" class="form-control" name="due_date" id="due_date" value="{{ old('due_date', $tasks->due_date) }}"/>
                                    </div>
